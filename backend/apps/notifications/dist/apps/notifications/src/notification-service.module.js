...
exports.NotificationServiceModule = NotificationServiceModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            aws_1.SESModule.forRoot(process.env.AWS_REGION || 'us-east-1'),
            aws_1.SNSModule.forRoot(process.env.AWS_REGION || 'us-east-1'),
            aws_1.SQSModule.forRoot(process.env.AWS_REGION || 'us-east-1'),
            utils_1.ThirdPartyModule.forRoot({
                twilio: {
