...
import { DatabaseModule } from '@cardinal/database';
import { LoggerModule } from '@cardinal/logger';
import { SESModule } from '@cardinal/aws-ses';
import { SNSModule } from '@cardinal/aws-sns';
import { SQSModule } from '@cardinal/aws-sqs';
import { ThirdPartyModule } from '@cardinal/third-party';
